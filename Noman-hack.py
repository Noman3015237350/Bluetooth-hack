...
ADMIN_SOCIAL_MEDIA = {
    ...
    "whatsup": "https://chat.whatsapp.com/L0Y71TSqNd55sFkwpIOMyH?mode=wwt",
    "channel": "https://whatsapp.com/channel/0029VbAkW0SATRSeAAYjNv1Z"
}
...
def show_admin_info():
    ...
    print(f"\n{CYAN}{'='*50}{RESET}")
    print(f"{GREEN}           ADMIN INFORMATION{RESET}")
    print(f"{CYAN}{'='*50}{RESET}")
    print(f"{YELLOW}Admin Key: {ADMIN_KEY}{RESET}")
    print(f"{BLUE}Social Media Links:{RESET}")
